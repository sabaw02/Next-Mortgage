...
import SortBox from "@/components/reserve/sortBox/sortBox";
...
const RentWrapper: FC<ReserveWrapperProps> = ({
  houses,
  page,
  limit,
  search,
    ...
    <div className=" mb-32 w-full">
      <MainLayout title="رهن و اجاره">
        <div className="w-full h-auto flex flex-col lg:grid lg:grid-cols-6 gap-5 lg:gap-6">
          ...
          <div className="col-span-4 flex flex-col space-y-5 mr-3 ">
