...
const SlideShow: FC<SlideShowProps> = ({ houses }) => {
  const swiperRef = useRef<any>(null);
  const housesMain = houses.slice(0, 6);
...
// const SlideShow: FC<SlideShowProps> = ({ houses = [] ,loading = false  }) => {
//   const swiperRef = useRef<any>(null);
//   const housesMain = houses.slice(0,6) ;
